...
<form name="Guardar_Limpiar" action="guardar_limpiar_categoria.php" method="post">
<table>
<tr><td colspan="8" align="center"><label class="label1">Registrar Categorías</label><hr></td></tr>
<tr>
	<td align="center"><label>Nombre</label> <input type="text" maxlength="50" name="txtnombre" required></td>
</tr>
...
<table class="tabla1">
<tr><td colspan="9" align="center"><label class="label2"> <br>Listado de Categorías</label> 
<form method="POST"><input type="submit" value="Buscar" name="buscar" style="float:left"></form>
<?php if(isset($_POST['buscar'])){header('location: busqueda_categoria.php');}?>
<hr></td></tr>
<tr class="tr1">
...
<tr class="tr2"> 
	...
	<td><?php echo "<a href=\"modificar_categoria.php?id_categoria=$mostrar[id_categoria]\">Modificar</a> 
	<a href=\"eliminar_categoria.php?id_categoria=$mostrar[id_categoria]\" 
	onClick=\"return confirm('¿Estás seguro de eliminar la categoría $mostrar[nombre_categoria]?')\">Eliminar</a></td>";?>
</tr>
<?php
}
?>
